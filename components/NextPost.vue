<template>
    <div class="inline-flex max-w-lg mx-auto justify-center">
        <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
            <a href="#">
                <img class="rounded-t-lg" v-bind:src="img" :alt="data.headline">
            </a>
            <div class="p-5">
                <a href="#">
                    <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">{{data.headline}}
                    </h5>
                </a>
                <p class="font-normal text-gray-700 mb-3">{{data.excerpt}}</p>
