<template>
    <div
        ...
        <div class='flex items-center justify-between font-medium'>
            <!--  :id="post.id" :categories="post.categories" :titulo="post.title" :texto="post.excerpt"
        ...
        <div class='flex flex-row items-center space-x-3'>
            <div class='flex flex-none items-center justify-center w-20 h-20 rounded-full bg-green-500 text-white'>
                <img :src="img" />
            </div>
    ...
    <!-- <div
        class='break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl min-w-[20rem] max-w-[23rem] p-4 mb-4 bg-[#5E17F4] text-white'>
